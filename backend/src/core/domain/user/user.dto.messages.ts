export const userDtoMessages = {
    ...
    phoneLength: "El teléfono debe estar formado por máximo 14 dígitos",
...
export const getUsersFilterDtoMessages = {
    roleInvalid: "El rol no es válido"
};

export const deleteUserDTOMessages = {
    idRequired: "El id es requerido",
    idInvalid: "El id no es válido"
};

export const userLocationDTOMessages = {
